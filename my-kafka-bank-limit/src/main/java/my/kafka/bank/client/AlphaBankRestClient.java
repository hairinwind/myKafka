...
public class AlphaBankRestClient {
    ...
    public static final String host1 = "http://localhost:9001";
    public static final String host2 = "http://localhost:9002";
    public static final String host3 = "http://localhost:9003";
    ...
    public static void moveMoney(String fromAccount, String toAccount, Double amount) {
        moveMoney(fromAccount, toAccount, amount, host1);
    }
